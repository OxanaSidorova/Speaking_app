...
* project was pushed to a master branch in GitHub instaed of main.
* the flask application doesnt have a Update and Delete functionality.
* Pycharm on my machine working very very slow. Need to get used to a different shell.

## Next Sprint improvments
* 
